package bsu.rfe.voznyuk.lab4.var3;
...
public class GraphicsDisplay extends JPanel {
    ...
    public GraphicsDisplay() {
        ...
        graphicsStroke = new BasicStroke(2.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND, 10.0f, new float[]{3, 9, 3, 12, 9, 3}, 0.0f);
    ...
    protected void paintAxis(Graphics2D canvas) {
        ...
        if (minX <= 0.0 && maxX >= 0.0) {
            ...
            GeneralPath vaertLine = new GeneralPath();
            Point2D.Double linePos = xyToPoint(0, 1);
            vaertLine.moveTo(linePos.getX()-10, linePos.getY());
            vaertLine.lineTo(linePos.getX()+10, linePos.getY());
            canvas.draw(vaertLine);


            //Point2D.Double labelPos21 = xyToPoint(0, 1);
            //canvas.drawString("—", (float) labelPos21.getX()-16, (float) (labelPos21.getY() - bounds21.getY()));
    ...
    protected boolean isEven(Double value) {
    ...
    protected void paintMarkers(Graphics2D canvas) {
        ...
        for (Double[] point : graphicsData) {
            ...
            path.append(new Line2D.Double(center.getX() - 3, center.getY(), center.getX() - 1, center.getY() - 1), false);
            path.append(new Line2D.Double(center.getX() - 1, center.getY() - 1, center.getX(), center.getY() - 3), false);
            path.append(new Line2D.Double(center.getX(), center.getY() - 3, center.getX() + 1, center.getY() - 1), false);
            path.append(new Line2D.Double(center.getX() + 1, center.getY() - 1, center.getX() + 3, center.getY()), false);
            path.append(new Line2D.Double(center.getX() + 3, center.getY(), center.getX() + 1, center.getY() + 1), false);
            path.append(new Line2D.Double(center.getX() + 1, center.getY() + 1, center.getX(), center.getY() + 3), false);
            path.append(new Line2D.Double(center.getX(), center.getY() + 3, center.getX() - 1, center.getY() + 1), false);
            path.append(new Line2D.Double(center.getX() - 1, center.getY() + 1, center.getX() - 3, center.getY()), false);
...
//            Point2D.Double center = xyToPoint(point[0], point[1]);
//            rhombus.moveTo(center.getX(), center.getY());
//            rhombus.moveTo(rhombus.getCurrentPoint().getX() - 5, rhombus.getCurrentPoint().getY());
//            rhombus.lineTo(rhombus.getCurrentPoint().getX() + 5, center.getY() + 5);
//            rhombus.lineTo(rhombus.getCurrentPoint().getX() + 5, rhombus.getCurrentPoint().getY() - 5);
//            rhombus.lineTo(rhombus.getCurrentPoint().getX() - 5, rhombus.getCurrentPoint().getY() - 5);
//            rhombus.lineTo(rhombus.getCurrentPoint().getX() - 5, rhombus.getCurrentPoint().getY() + 5);
//
//            canvas.draw(rhombus);
...
//            // markers
//            GeneralPath rhombus = new GeneralPath();
//            Point2D.Double center = xyToPoint(0, -3.01);
//            rhombus.moveTo(center.getX(), center.getY());
//            rhombus.moveTo(rhombus.getCurrentPoint().getX() - 5, rhombus.getCurrentPoint().getY());
//            rhombus.lineTo(rhombus.getCurrentPoint().getX() + 5, center.getY() + 5);
//            rhombus.lineTo(rhombus.getCurrentPoint().getX() + 5, rhombus.getCurrentPoint().getY() - 5);
